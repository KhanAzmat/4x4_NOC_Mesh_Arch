...
#define NR_HARTS        25 //num of heart 
#define SOURCE_BASE_ID  32 //we reserve first 31 pending bit, start from 32
#define SLOT_PER_TARGET 25 //reserve 25 source id for each target

#define PLIC_0_C0C1_BASE  0x0041000030000000
#define PLIC_0_NXY_BASE   0x0041001130000000  

#define PLIC_1_C0C1_BASE  0x0041000030400000
#define PLIC_1_NXY_BASE   0x0041001130400000

#define PLIC_2_C0C1_BASE  0x0041000030800000
#define PLIC_2_NXY_BASE   0x0041001130800000

// #define PLIC_TARGET_BASE 

#define PLIC_SIZE       0x0000000000400000
